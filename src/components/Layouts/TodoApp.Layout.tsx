...
const TodoAppLayout:React.FC<PLayout>=(props)=>{
  return (
    <>
      <div data-cy="header-title" style={{height:headerHeight,width:"100%",backgroundColor:"#16ABF8",boxShadow:"0px 4px 10px rgba(0, 0, 0, 0.1)"}}>
